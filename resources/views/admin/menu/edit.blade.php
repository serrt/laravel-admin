    ...
    <div class="box-body">
        <form action="{{route('admin.menu.update', $menu)}}" class="form-horizontal validate" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <select name="permission_id" id="selectPermission" class="form-control select2" data-json="{{json_encode($permission)}}" data-ajax-url="{{route('api.web.permission')}}"></select>
                </div>
            </div>
            <div class="form-group">
